...
// Daniel Rozin
// copying live video with transparancy to create ghosting effect

import processing.video.*;
float[][][] floatPixels = new float[1280][720][3];                       // an array of floats to hold our image in higher color depth resolution (32 bits per channel)
